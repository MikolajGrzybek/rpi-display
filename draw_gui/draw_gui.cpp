...
UBYTE Display_InitGui(UWORD Panel_Width, UWORD Panel_Height, UDOUBLE Init_Target_Memory_Addr){
    ...
    paint_string(font_small, t_boat_status, T_BOAT_STATUS_L, 1020 + SMALL_FONT_W, 160 + SMALL_FONT_H, SMALL_FONT_BRIGHTEN);

    // GPS FIX STATUS
    FT_ULong t_gps_fix_status[] = T_GPS_FIX;
    paint_string(font_small, t_boat_status, T_GPS_FIX_L, 1020 + SMALL_FONT_W, 270 + SMALL_FONT_H, SMALL_FONT_BRIGHTEN);
